...
It is a project that aims to organize customer information in a database called Registration Form.
...
# Technologies
 ...
 - **Axios**, is an HTTP client based on **Promises** to make requests. It can be used in the browser as in Node.js or any API service. I used axios to assist me in requesting HTTP within the project.
